...
def main():
    ...
    if args.input_stdin:
        ...
        wtdata = osmdi.WikitextAsData().set_wikitext(wikitext)
    elif args.input_autodetect:
        wtdata = osmdi.WikitextAsData().set_pages_autodetect(
            args.input_autodetect
        )
    elif args.page_title:
        wtdata = osmdi.WikitextAsData().set_titles(args.page_title)
    elif args.pageids:
        wtdata = osmdi.WikitextAsData().set_pageids(args.pageids)
    elif args.revids:
        wtdata = osmdi.WikitextAsData().set_revids(args.revids)
    # elif args.wikibase_ids:
    #     wtdata = osmdi.WikitextAsData().set_wikibaseids(args.wikibase_ids)
